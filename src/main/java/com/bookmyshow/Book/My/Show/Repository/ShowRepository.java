...
public interface ShowRepository extends JpaRepository<Show, UUID> {
    ...
    @Modifying
    @Transactional
    @Query(value = "update show set available_tickets=:updateTicketCount where id=:ShowId", nativeQuery = true)
    public void updateAvailableTicketCount(UUID ShowId, int updateTicketCount);
}
